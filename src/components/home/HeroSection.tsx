    ...
    <section className="border-b border-line bg-surface-sunken">
      <Container>
        <div className="grid gap-10 py-12 sm:py-16 lg:grid-cols-[1.15fr_1fr] lg:items-center lg:gap-14 lg:py-20">
          {/* 왼쪽 — 슬로건 */}
          <div>
            <p className="inline-flex items-center gap-2 rounded-full border border-brand-200 bg-brand-50 px-3 py-1.5 text-[12.5px] font-semibold text-brand-700">
              지금은 {season.label}
            ...
            <h1 className="mt-5 text-[34px] leading-[1.22] font-bold tracking-tight text-ink-900 sm:text-[44px]">
              숨쉬기 좋은 길로
              <br />
              갑니다
            </h1>

            <p className="mt-5 max-w-lg text-[15px] leading-relaxed text-ink-500 sm:text-base">
          ...
          <div className="rounded-2xl border border-line bg-surface p-5 shadow-sm sm:p-6">
            ...
            <div className="mt-5 rounded-lg bg-surface-sunken px-4 py-3">
              <div className="flex items-baseline justify-between gap-2">
                ...
                <span className="tabular text-[15px] font-bold text-risk-high">
            ...
            <dl className="mt-4 grid grid-cols-2 gap-3">
              <div className="rounded-lg border border-line px-3.5 py-3">
                <dt className="text-[11.5px] font-medium text-ink-400">가장 높은 곳</dt>
              ...
              <div className="rounded-lg border border-line px-3.5 py-3">
                <dt className="text-[11.5px] font-medium text-ink-400">가장 낮은 곳</dt>
                <dd className="mt-1 text-[14px] font-semibold text-ink-900">
                  {best.areaName}{' '}
            ...
            {snapshot.warnings.length > 0 && (
              <ul className="mt-4 space-y-1.5">
                {snapshot.warnings.map((w) => (
                  <li
                    key={w.title}
                    className="flex items-center gap-2 rounded-md bg-risk-very-high/8 px-3 py-2 text-[12.5px] font-medium text-risk-very-high"
                  >
            ...
            <p className="mt-4 border-t border-line pt-3 text-[11.5px] text-ink-400">
              기준 {formatKstLong(snapshot.baseTime)} · 기상청·에어코리아 공공데이터
            </p>
          </div>
        </div>
      </Container>
